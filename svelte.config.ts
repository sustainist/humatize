                        ...
                        if (nodeYaml) {
                            ...
                            nodeYaml.value!.split("\n").forEach((line) => {
                                ...
                                if (values[0] === 'title') {
                                    ...
                                    header += `<h1 style="font-size:clamp(0.83rem,5vw,2rem);text-align:center;font-weight:normal;text-transform:uppercase;letter-spacing:2px"><a style="color:inherit;text-decoration:none" href="/">${value}</a></h1>`
